...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://blind-manya-autocool-ebdfb3c7.koyeb.app/") # Fill env at deoplyment time Stream Mode Is True else avoide
